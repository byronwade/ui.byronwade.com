...
export default function HomePage() {
  return (
    <main className="relative min-h-dvh overflow-x-clip bg-background text-foreground">
      ...
      {/* ====================================================== HERO ===== */}
      <section className="mx-auto flex min-h-dvh max-w-4xl flex-col items-center justify-center px-6 pb-24 pt-28 text-center sm:pt-32">
...
.dark { --brand: oklch(0.65 0.20 25); }`}
      ...
      {/* ================================================ FOOTER CTA ===== */}
      <section className="relative mx-auto max-w-5xl px-6 py-28 text-center sm:py-36">
        <Reveal>
