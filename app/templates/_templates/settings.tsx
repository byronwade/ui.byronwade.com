            ...
            <section id="notifications" className="scroll-mt-20">
              ...
              >
                <SettingsList>
                  ...
                  <SettingRow
                    title="Weekly digest"
                    description="A Monday summary of your activity."
                    control={<Switch />}
                  />
                  <SettingRow
                    title="Marketing"
                    description="Tips, offers, and company news."
                    control={<Switch />}
                  />
                </SettingsList>
              </Section>
            ...
            <section id="billing" className="scroll-mt-20">
              ...
              >
                <div className="space-y-5 p-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Visa ending 4242 · renews Jun 1, 2027
                      </div>
                    </div>
                    <Button variant="outline" size="sm">
                      Update
                  ...
                  <div className="edge divide-y divide-border rounded-xl">
                    {invoices.map((inv) => (
                      <div
                        key={inv.id}
