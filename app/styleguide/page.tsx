import { AlignCenterIcon, AlignLeftIcon, AlignRightIcon, BoldIcon, Check, CheckCircle2, FileTextIcon, Inbox, ItalicIcon, Plus, SearchIcon, Settings, UnderlineIcon, X } from "lucide-react";
          ...
          <main className="min-w-0 space-y-20">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {[
                        ...
                        { label: "Rich inventory", href: "/layouts/rich-inventory" },
                        { label: "Centered tool", href: "/layouts/centered-tool" },
            ...
            <Reveal delay={320}>
              ...
              >
                ...
                <Specimen name="ToggleGroup" from="@/components/ui/toggle-group">
                ...
                <Specimen name="InputGroup" from="@/components/ui/input-group">
                  <div className="max-w-sm space-y-2">
                    <InputGroup>
                      ...
                      <Input placeholder="Search projects…" className="border-0 bg-transparent shadow-none" />
                    </InputGroup>
                  </div>
                </Specimen>
              </Section>
            ...
            <Reveal delay={400}>
              ...
              >
                ...
                <Specimen name="NavigationMenu" from="@/components/ui/navigation-menu">
                  <NavigationMenuDemo />
                </Specimen>
                    ...
                    <div className="p-4 space-y-2">
                      {Array.from({ length: 12 }, (_, i) => (
                        <div key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span>Document {String(i + 1).padStart(2, "0")}.pdf</span>
                        </div>
                      ))}
                    </div>
                  </ScrollArea>
                ...
                <Specimen name="Collapsible" from="@/components/ui/collapsible">
                  <Collapsible className="max-w-xs">
                    ...
                    <CollapsibleContent className="mt-1 rounded-lg border border-border px-4 py-3">
                      <p className="text-sm text-muted-foreground">
                        Debug mode, verbose logging, and rate limit overrides live here.
                      </p>
                    </CollapsibleContent>
                  </Collapsible>
                </Specimen>
                ...
                <Specimen name="VerificationProgress" from="@/components/verification-progress" plain>
                  <div className="edge space-y-6 rounded-xl bg-background p-6">
                    ...
                    <div className="border-t border-border pt-5">
                      <VerificationProgress
                        steps={[
                          { tone: "success", label: "Brand registered", description: "Carrier approved" },
                          { tone: "success", label: "Number verified", description: "Calls active" },
                          { tone: "warning", label: "SMS pending", description: "Awaiting review" },
                          { tone: "neutral", label: "A2P 10DLC", description: "Not started" },
                        ]}
                      />
                    </div>
                  </div>
              ...
              >
                ...
                >
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Open the gallery to inspect each at any viewport, in either theme — and re-skin them live.
                    </p>
                  </div>
                  <span className={buttonVariants({ size: "sm" })}>Explore layouts →</span>
                </Link>
