      ...
      actions={
        <>
          ...
          <Button variant="ghost" size="default" asChild>
            <Link href="/meridian/system/ux">UX</Link>
          </Button>
          <Button variant="ghost" size="default" asChild>
            <Link href="/meridian/system/dx">DX</Link>
          </Button>
          <Button variant="ghost" size="default" asChild>
            <Link href="/meridian/surfaces#proofs">Proofs</Link>
          </Button>
        </>
      }
    >
      ...
      <section id="skills" className="scroll-mt-24">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <Button variant="outline" size="default" asChild>
            <Link href="/meridian/skills">All skills</Link>
          </Button>
        </div>
