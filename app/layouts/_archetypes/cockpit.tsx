...
const threads: Thread[] = [
  {
    id: "inc-4821",
    from: "Pager · us-east-1",
    subject: "Elevated error rate on checkout",
    preview: "5xx ratio crossed 2% for 4 minutes…",
    time: "2m",
    tone: "danger",
    tag: "P1",
    priority: "Urgent",
    ...
    unread: true,
    detail:
      "Error budget burn accelerated after the 14.0 deploy. Rollback initiated; traffic shifting to the previous revision.",
    meta: [
      { label: "Service", value: "checkout-api" },
      { label: "Region", value: "us-east-1" },
      { label: "Owner", value: "Payments" },
      { label: "Started", value: "12:02 UTC" },
    ],
    affected: ["checkout-api", "payments-svc", "cart-edge"],
    errors: [1, 1, 2, 3, 6, 9, 12, 14, 11, 8],
  },
  {
    id: "inc-4820",
    from: "Pager · eu-west-1",
    subject: "Queue depth above threshold",
    preview: "Worker backlog at 12k and rising…",
    time: "18m",
    tone: "warning",
    tag: "P2",
    priority: "High",
    ...
    unread: true,
    detail:
      "Background job queue is draining slower than ingest. Auto-scaling added 4 workers; backlog projected clear in ~20m.",
    meta: [
      { label: "Service", value: "jobs-worker" },
      { label: "Region", value: "eu-west-1" },
      { label: "Owner", value: "Platform" },
      { label: "Started", value: "11:46 UTC" },
    ],
    affected: ["jobs-worker", "ingest-api"],
    errors: [4, 5, 6, 6, 7, 8, 9, 8, 7, 7],
  },
  {
    id: "inc-4818",
    from: "Sentry",
    subject: "New issue: TypeError in Billing",
    ...
    assignee: "Marc Vidal",
    detail:
      "A null invoice line item slipped past validation. Affects 0.3% of sessions; non-blocking but noisy in logs.",
    meta: [
      { label: "Service", value: "billing-web" },
      { label: "Release", value: "v2.13.7" },
      { label: "Owner", value: "Billing" },
      { label: "Events", value: "214" },
    ],
    affected: ["billing-web"],
    errors: [2, 2, 3, 2, 3, 3, 4, 3, 3, 2],
  },
  {
    id: "inc-4805",
    from: "Status · CDN",
    subject: "Edge cache hit ratio recovered",
    preview: "Hit ratio back above 96%…",
    time: "3h",
    tone: "success",
    tag: "Resolved",
    priority: "Low",
    assignee: "Liam Cho",
    detail:
      "Cache hit ratio dipped during the config push and has fully recovered. No customer impact recorded.",
    meta: [
      { label: "Service", value: "edge-cdn" },
      { label: "Region", value: "global" },
      { label: "Owner", value: "Edge" },
      { label: "Closed", value: "09:12 UTC" },
    ],
    affected: ["edge-cdn"],
    errors: [6, 5, 5, 4, 3, 2, 2, 1, 1, 1],
  },
  {
    id: "inc-4799",
    from: "Cron",
    subject: "Nightly export finished",
    preview: "Exported 1.2M rows in 03:41…",
    time: "8h",
    tone: "neutral",
    tag: "Info",
    priority: "None",
    assignee: "Sara Kim",
    detail:
      "Scheduled analytics export completed successfully and uploaded to the warehouse bucket.",
    meta: [
      { label: "Job", value: "warehouse-export" },
      { label: "Rows", value: "1,204,882" },
      { label: "Duration", value: "03:41" },
      { label: "Status", value: "OK" },
    ],
    affected: ["warehouse-export"],
...
export function CockpitArchetype() {
  ...
  return (
    <div className="flex h-dvh bg-background text-foreground">
      ...
      <nav
        aria-label="Primary"
        className="hidden w-14 shrink-0 flex-col items-center gap-1 border-r border-border py-3 sm:flex"
      >
                  ...
                  >
                    <span
                      className={cn(
                        ...
                        isActive ? dotBar[t.tone] : "bg-transparent",
                      )}
                    />
              ...
              <Tabs defaultValue="overview" className="mt-6 w-full">
                ...
                <TabsContent value="activity">
                  <EventTimeline
                    events={[
                      {
                        title: "Acknowledged by on-call",
                        tone: "info",
                        timestamp: `${active.time} ago`,
                      },
                      {
                        title: "Auto-remediation triggered",
                        tone: "warning",
                        timestamp: "moments later",
                        description: "Runbook step 2 executed.",
                      },
                      {
                        title: "Alert opened",
                        tone: "danger",
                        timestamp: "at start",
                        description:
                          "Threshold breached for 4 consecutive minutes.",
                      },
                    ]}
                  />
                </TabsContent>
