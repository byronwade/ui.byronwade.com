...
/**
 * Button class-variance-authority recipe, kept in its own module (no
 * "use client") so it can be imported from BOTH server and client components.
 * `button.tsx` re-exports this for backward compatibility; server components
 * that only need the classes should import it from here directly.
 */
