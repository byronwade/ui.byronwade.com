...
export const EditorProvider = ({
  ...
  const defaultExtensions = [
    StarterKit.configure({
      ...
      blockquote: {
        HTMLAttributes: {
          class: cn("border-l-2 border-border pl-2"),
        },
      },
      code: {
        HTMLAttributes: {
    ...
    CodeBlockLowlight.configure({
      lowlight,
      HTMLAttributes: {
        // Highlight tones map onto the token palette + chart ramp so the block
        // re-skins for free in dark mode and when --brand is overridden. The
        ...
        class: cn(
          ...
          "[&_.hljs-attr]:text-chart-1 [&_.hljs-attribute]:text-chart-1 [&_.hljs-literal]:text-chart-1 [&_.hljs-meta]:text-chart-1 [&_.hljs-number]:text-chart-1 [&_.hljs-operator]:text-chart-1 [&_.hljs-selector-attr]:text-chart-1 [&_.hljs-selector-class]:text-chart-1 [&_.hljs-selector-id]:text-chart-1 [&_.hljs-variable]:text-chart-1",
          "[&_.hljs-meta_.hljs-string]:text-chart-3 [&_.hljs-regexp]:text-chart-3 [&_.hljs-string]:text-chart-3",
          "[&_.hljs-built_in]:text-chart-5 [&_.hljs-symbol]:text-chart-5",
          "[&_.hljs-code]:text-muted-foreground [&_.hljs-comment]:text-muted-foreground [&_.hljs-formula]:text-muted-foreground",
          "[&_.hljs-name]:text-success [&_.hljs-quote]:text-success [&_.hljs-selector-pseudo]:text-success [&_.hljs-selector-tag]:text-success",
          "[&_.hljs-subst]:text-foreground",
          "[&_.hljs-section]:font-medium [&_.hljs-section]:text-chart-1",
          "[&_.hljs-bullet]:text-warning",
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(className, "[&_.ProseMirror-focused]:outline-none")}
        data-slot="editor"
      >
        <TiptapEditorProvider
          editorProps={{
            attributes: {
              // The contenteditable surface is an ARIA textbox; give it an
              // accessible name out of the box (callers may override via
              // editorProps). Placeholder alone is not an accessible name.
...
export const EditorFloatingMenu = ({
  ...
  return (
    <FloatingMenu
      ...
      data-slot="editor-floating-menu"
      editor={editor ?? null}
      {...props}
    />
  )
...
type EditorButtonProps = {
  ...
  isActive: () => boolean
  command: () => void
  icon: Icon | ((props: IconProps) => ReactNode)
  hideName?: boolean
}
      ...
      <PopoverTrigger
        render={
          <Button
            ...
            data-slot="editor-selector-trigger"
            size="sm"
            variant="ghost"
          />
        }
    ...
    <Popover modal onOpenChange={onOpenChange} open={open}>
      <PopoverTrigger
        render={
          <Button
            className="gap-2 rounded-none border-none"
            data-slot="editor-link-selector-trigger"
            size="sm"
            variant="ghost"
          />
        }
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        render={
          <Button aria-label="Column options" size="icon" variant="ghost" />
        }
        style={{ top, left }}
      >
        <DotsThree className="text-muted-foreground" size={16} />
      </DropdownMenuTrigger>
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        style={{ top, left }}
      >
        <DotsThreeVertical className="text-muted-foreground" size={12} />
      </DropdownMenuTrigger>
      <DropdownMenuContent>{children}</DropdownMenuContent>
    </DropdownMenu>
  )
...
export const EditorTableHeaderColumnToggle = () => {
  ...
  return (
    <Tooltip>
      ...
      >
        <Columns className="text-muted-foreground" size={16} />
      </TooltipTrigger>
      <TooltipContent>
...
export const EditorTableHeaderRowToggle = () => {
  ...
  return (
    <Tooltip>
      ...
      >
        <Rows className="text-muted-foreground" size={16} />
      </TooltipTrigger>
      <TooltipContent>
...
export const EditorTableMergeCells = () => {
  ...
  return (
    <Tooltip>
      ...
      >
        <TableIcon className="text-muted-foreground" size={16} />
      </TooltipTrigger>
      <TooltipContent>
...
export const EditorTableFix = () => {
  ...
  return (
    <Tooltip>
      ...
      >
        <Lightning className="text-muted-foreground" size={16} />
      </TooltipTrigger>
      <TooltipContent>
        <span>Fix table</span>
      </TooltipContent>
