---
name: atlas-theme
description: Theme tokens and closed prefs for Atlas. Use when changing brand, paper, or radius under Atlas.
---

# Atlas theme

Closed tokens for **Atlas**. Prefer skills + CI; MCP `apply_prefs` is optional.

## Steps

1. Read `contracts/atlas/DESIGN.md` and `docs/atlas.md`.
2. Skin via `data-contract="atlas"` (this site) or `CONTRACT_ID=atlas` in consuming apps.
