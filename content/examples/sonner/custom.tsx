  ...
  return (
    <div className="flex flex-col items-start gap-3 p-8">
      ...
      <button
        ...
        onClick={() =>
          toast.custom((id) => (
            <div className="flex items-center gap-3 rounded-lg edge bg-background px-4 py-3 edge w-72">
      ...
      <button
        ...
        onClick={() =>
          toast.custom((id) => (
            <div className="flex items-start gap-3 rounded-lg border border-brand/20 bg-brand/10 px-4 py-3 edge w-80">
              <div className="flex-1 min-w-0">
