  ...
  return (
    <CenteredFocal backdrop={<GridBackdrop />}>
      <div className="flex flex-col items-center gap-4">
        ...
        <div>
          <h2 className="text-base font-semibold text-foreground">Connect your data source</h2>
          <p className="mt-1 text-sm text-muted-foreground">Choose a source to start streaming events into your workspace.</p>
        </div>
