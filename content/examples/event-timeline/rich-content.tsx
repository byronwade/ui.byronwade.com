...
const events: TimelineEvent[] = [
  {
    ...
    description: (
      <span>
        Branch <code className="font-mono text-xs">feat/dark-mode</code> →{" "}
        <code className="font-mono text-xs">main</code>. Approved by 2
        reviewers.
      </span>
    ),
  ...
  },
  {
    ...
    description: (
      <span>
        Step <code className="font-mono text-xs">lint</code> exited with code{" "}
        <code className="font-mono text-xs">1</code>. 3 errors found.
      </span>
    ),
