        ...
        groups={[
          {
            label: "May 31",
            items: [
              { tone: "success", title: "Published release v2.4.0", meta: "09:12" },
          ...
          },
          {
            label: "May 30",
            items: [
              { tone: "warning", title: "High memory usage detected", meta: "22:03" },
          ...
          },
          {
            ...
            items: [
              ...
              { tone: "success", title: "Auto-recovery succeeded",    meta: "14:31" },
            ],
          },
        ]}
