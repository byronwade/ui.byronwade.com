...
const NOTCH = "radial-gradient(circle 18px at 40px 16px, transparent 17px, #000 18px)";
				...
				<div className="flex items-center">
					{participants.map((seed, i) => (
						<span
							...
							style={{ marginLeft: i === 0 ? 0 : "-8px", zIndex: i, maskImage: NOTCH, WebkitMaskImage: NOTCH }}
						>
