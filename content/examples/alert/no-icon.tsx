  ...
  return (
    <div className="flex flex-col gap-4 p-6 max-w-lg">
      ...
      <Alert>
        ...
        <AlertDescription>
          Review your usage and adjust your plan before the billing date to
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Your account has been suspended due to a policy violation. Contact
          support to appeal.
        </AlertDescription>
      </Alert>
      ...
      <Alert>
        <AlertDescription>
          A new privacy policy is in effect as of May 1. By continuing you agree
