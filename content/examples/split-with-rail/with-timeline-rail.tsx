            ...
            groups={[
              {
                label: "Today",
                items: [
                  { glyph: <Globe className="size-3.5" />, title: "Visited /pricing", meta: "2m ago" },
                  { glyph: <MousePointer className="size-3.5" />, title: "Clicked 'Start trial'", meta: "3m ago" },
                  { glyph: <Globe className="size-3.5" />, title: "Visited /features", meta: "5m ago" },
                  { glyph: <Globe className="size-3.5" />, title: "Visited /home", meta: "8m ago" },
                ],
              },
              {
                label: "Yesterday",
                items: [
                  { glyph: <GitBranch className="size-3.5" />, title: "OAuth sign-in via GitHub", meta: "1d ago" },
                  { glyph: <Globe className="size-3.5" />, title: "Visited /docs/quickstart", meta: "1d ago" },
                  { glyph: <Globe className="size-3.5" />, title: "Visited /home", meta: "1d ago" },
                ],
              },
            ]}
          />
