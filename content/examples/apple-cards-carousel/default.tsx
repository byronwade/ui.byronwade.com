...
const DATA = [
  {
    ...
    content: <p className="text-muted-foreground">Compose primitives, not pixels.</p>,
  },
  {
    category: "Engineering",
    title: "Tokens that re-skin in one variable.",
    src: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop",
    content: <p className="text-muted-foreground">Override --brand and the system follows.</p>,
  },
  {
    category: "Design",
    ...
    content: <p className="text-muted-foreground">Hierarchy from size and tracking.</p>,
  },
];
